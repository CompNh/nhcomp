...
declare const GridContainer: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('react').DetailedHTMLProps<import('react').HTMLAttributes<HTMLDivElement>, HTMLDivElement>, never>> & string;
declare const GridTableWrapper: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components/dist/types').Substitute<import('react').DetailedHTMLProps<import('react').HTMLAttributes<HTMLDivElement>, HTMLDivElement>, {
    $maxHeight?: number | null;
}>> & string;
declare const GridTable: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('react').DetailedHTMLProps<import('react').TableHTMLAttributes<HTMLTableElement>, HTMLTableElement>, never>> & string;
...
declare const GridPaginationWrapper: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('react').DetailedHTMLProps<import('react').HTMLAttributes<HTMLDivElement>, HTMLDivElement>, never>> & string;
declare const PlaceholderRow: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('react').DetailedHTMLProps<import('react').HTMLAttributes<HTMLTableRowElement>, HTMLTableRowElement>, never>> & string;
declare const PlaceholderCell: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('react').DetailedHTMLProps<import('react').TdHTMLAttributes<HTMLTableDataCellElement>, HTMLTableDataCellElement>, never>> & string;
export { ContextMenuContainer, ContextMenuHeader, ContextMenuList, ContextItem, ContextDivider, ContextIcon, ConfirmButton, CancelButton, TableBody, TableRow, GroupRowtr, GroupTableCell, GroupRowContent, TableCell, HeaderWrapper, HeaderRow, HeaderCell, FilterRow, FilterInput, HeaderContent, GridContainer, GridTable, GridPaginationWrapper, GridTableWrapper, PlaceholderRow, PlaceholderCell };
