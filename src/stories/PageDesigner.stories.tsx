...
const sampleData: SampleData[] = [
  ...
  const formFields: FormField[] = [
    { label: "이름", key: "name", position : [1,1], isRequired: true, toolTip: "이름을 입력하시오", defaultValue: {min : 0, max : 0}, component: <TextBox textType="rangeNumber"/> , filter : filterNumber},
    ...
    { label: "창고 선택", key: "warehouse",position : [2,2], component: <DropDownBox options={sampleDropData} onChange={onChanged}/>, defaultValue :'1' }
  ];
